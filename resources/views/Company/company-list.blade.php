                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="email" id="emailMask" required />
                                </div>
                                <div class="col-md-4">
                                    <label>Company Type</label>
                                    <select name="company_type_id" class="form-control" id="company_type" style="width: 100%">
                                        @foreach($constant as $cons)
                                            <option value="{{ $cons->id }}">{{ $cons->value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label>Website URL</label>
                                    <input type="text" class="form-control" name="website_url" id="urlMask" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Address Line 1</label>
                                    <textarea name="address_1" class="form-control" rows="4" required></textarea>
                                </div>
                                <div class="col-md-12">
                                    <label>Address Line 2</label>
                                    <textarea name="address_2" class="form-control" rows="4" required></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-4">
...
<div class="modal fade" id="delete{{ $row->id }}" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form action="company/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Remove Record</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
