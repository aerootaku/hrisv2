...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Policy List</h3>
                </div>
            ...
            <div class="modal-content">
                <form action="policy" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="title" id="defaultModalLabel">New Policy Record</h4>
                    </div>
    ...
    @foreach($data as $row)
        <div class="modal fade" id="edit{{ $row->id }}" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <form action="policy/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Title</label>
                                        <textarea name="title" class="form-control"   required >{{$row->title}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
