...
@section('content')
    ...
    <div class="modal fade" id="create" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form action="employee-promotion" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="title" id="defaultModalLabel">New Promotion Record</h4>
                    </div>
    ...
    @foreach($data as $row)
        <div class="modal fade" id="edit{{ $row->id }}" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <form action="employee-promotion/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Date</label>
                                        <input type="date" class="form-control" name="promotion_date" value="{{$row->promotion_date}}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
