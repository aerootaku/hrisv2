                    ...
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h5 class="kt-portlet__head-title">
                                Employee Name: {{ strtoupper($employee_info->lastname . ", " . $employee_info->firstname . " " . $employee_info->middlename . " PAYSLIP") }}
                                <br />
                                Expected Total Working hours: {{ $totalWorkingHours }}
                                <br />
                                Actual Employee Working hours: {{ $cutoffWorkingHours->work_hours }}
                                <br />
                                Days Present: {{ number_format($cutoffWorkingHours->days_work, 0) }}
                                <br />
