...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Philhealth Tax List</h3>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Philhealth Tax List</h4>
                                </div>
    ...
    <div class="modal fade" id="create" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <form action="tax-philhealth" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="title" id="defaultModalLabel">New Philhealth Tax Record</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Share</label>
                                    <input type="number" class="form-control" name="share"   required>
                                </div>
                            </div>
                        </div>
    ...
    @foreach($data as $row)
        <div class="modal fade" id="edit{{ $row->id }}" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <form action="tax-philhealth/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Minimum</label>
                                        <input type="number" class="form-control" name="minimum" value="{{ $row->minimum }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Maximum</label>
                                        <input type="number" class="form-control" name="maximum" value="{{ $row->maximum}}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Share</label>
                                        <input type="number" class="form-control" name="share" value="{{ $row->share }}"  required>
                                    </div>
                                </div>
