        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Rate Template List</h3>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Rate Template List</h4>
                                </div>
            ...
            <div class="modal-content">
                <form action="rate-template" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="title" id="defaultModalLabel">New Rate Template Record</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Per Day</label>
                                    <input type="number" class="form-control" name="per_day" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Rate Name</label>
                                        <input type="text" class="form-control" name="rate_name" value="{{ $row->rate_name }}"  required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Per Day</label>
                                        <input type="number" class="form-control" name="per_day" value="{{ $row->per_day }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Hours</label>
                                        <input type="number" class="form-control" name="hours"  value="{{ $row->hours }}" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Per Hour</label>
                                        <input type="number" class="form-control" name="per_hour"  value="{{ $row->per_hour }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
