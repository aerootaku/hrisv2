        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Withholding Tax List</h3>
                </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table class="table table-striped table-bordered dataex-res-configuration">
                                            ...
                                            <tr>
                                                <th>Type</th>
                                                <th>Minimum Compensatory</th>
                                                <th>Maximum Compensatory</th>
                                                <th>Percentage</th>
                                                <th>Amount</th>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <input type="number" class="form-control" name="minimum_compensatory"  required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Maximum Compensatory</label>
                                    <input type="number" class="form-control" name="maximum_compensatory" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Employee Contribution</label>
                                    <input type="number" class="form-control" name="employee_contribution"   required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label>Minimum Compensatory</label>
                                        <input type="number" class="form-control" name="minimum_compensatory" value="{{ $row->minimum_compensatory }}"  required>
                                    </div>
                                </div>
