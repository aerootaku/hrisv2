                    ...
                    <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__section ">
                                <h4 class="kt-menu__section-text">My Profile</h4>
                                <i class="kt-menu__section-icon flaticon-more-v2"></i>
                            </li>
                            <li class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="{{ url('employee-profile/'.Auth::user()->employee_id) }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon"><span class="la la-dashboard"></span></span><span class="kt-menu__link-text">Profile</span></a></li>
                            <li class="kt-menu__item  kt-menu__item" aria-haspopup="true"><a href="{{ url('attendance-time') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon"><span class="la la-clock-o"></span></span><span class="kt-menu__link-text">My DTR</span></a></li>
                            <li class="kt-menu__item  kt-menu__item" aria-haspopup="true"><a href="{{ url('my-leave') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon"><span class="la la-list"></span></span><span class="kt-menu__link-text">My Leave</span></a></li>

                            <li class="kt-menu__item  kt-menu__item" aria-haspopup="true"><a href="{{ url('employee-leave') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon"><span class="la la-dashboard"></span></span><span class="kt-menu__link-text">Leave List</span></a></li>
                            <li class="kt-menu__item  kt-menu__item" aria-haspopup="true"><a href="{{ url('employee-ob') }}" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon"><span class="la la-ticket"></span></span><span class="kt-menu__link-text">Official Business</span></a></li>
            ...
            @if(Auth::user()->role_id == '1')
                ...
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        ...
                        <li class="kt-menu__section ">
                            <h4 class="kt-menu__section-text">Organization</h4>
                            <i class="kt-menu__section-icon flaticon-more-v2"></i>
                        </li>
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <span class="kt-menu__link-icon"><i class="la la-briefcase"></i> </span>
                                <span class="kt-menu__link-text">Organization</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                            </a>
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('company') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Company</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('branch') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Branch</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('department') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Department</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('designation') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Designation</span></a></li>
                                    {{--<li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('user-groups') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">User Groups</span></a></li>--}}
                                    {{--<li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('announcement') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Announcements</span></a></li>--}}
                                    {{--<li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('policy') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Policies</span></a></li>--}}
                                </ul>
                            </div>
                        </li>
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <span class="kt-menu__link-icon"><i class="la la-group"></i> </span>
                                <span class="kt-menu__link-text">Employee</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                            </a>
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Subheaders</span></span></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee List</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-setrole') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Set Roles</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-transfer') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Transfer</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-resignation') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Resignation</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-travel') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Travel</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-promotion') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Promotion</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-complaint') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Complaints</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-warning') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Warning</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-termination') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Termination</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-lastlogin') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Last Login</span></a></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-exit') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Exit</span></a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                <span class="kt-menu__link-icon"><i class="la la-clock-o"></i> </span>
                                <span class="kt-menu__link-text">Attendance</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                            </a>
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    <li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Subheaders</span></span></li>
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-attendance') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Attendance List</span></a></li>
                                    {{--<li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('attendance-dtr') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Generate DTR</span></a></li>--}}
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-ob') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Official Business</span></a></li>
                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                            ...
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item " aria-haspopup="true"><a href="{{ url('employee-salary-adjustment') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Employee Salary Adjustment</span></a></li>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <span class="kt-header__topbar-username kt-hidden-mobile">{{ \App\Employee::find(Auth::user()->employee_id)->firstname ?? 'Admin' }}</span>
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                            ...
                            <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url({{ asset('assets') }}/media/misc/bg-1.jpg)">
                                ...
                                <div class="kt-user-card__name">
                                    {{ \App\Employee::find(Auth::user()->employee_id)->firstname ?? 'Kio'}} {{ \App\Employee::find(Auth::user()->employee_id)->lastname ?? 'Hoviera' }}
                                </div>
                            </div>
                            ...
                            <div class="kt-notification">
                                <a href="{{ url('employee-profile/'.Auth::user()->employee_id) }}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
